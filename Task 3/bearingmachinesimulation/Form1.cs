    ...
    public partial class Form1 : Form
    {
       public static BearingMachineModels.SimulationSystem mysystem = new BearingMachineModels.SimulationSystem(); 
        ...
        private void Simulate_Click(object sender, EventArgs e)
        {
            ...
            f3.Show();
            string s = TestingManager.Test(mysystem, Constants.FileNames.TestCase3);
            MessageBox.Show(s);
        }
        ...
        {
            simulator.load(mysystem);
            simulator.read_from_file(down_time_cost, Repair_person_cost, Bearing_cost, Num_of_hours, Num_of_bearings, Repair_Time_for_one_Bearing, Repair_Time_for_all_bearings, dataGridView2, dataGridView1);
        }
